...
class ssdr {
  ...
  public:
    ...
    void match_samples_to_curve2(void);
    void normalize_tgs(void);
    void find_correspondence(void);
    void find_correspondence2(void);
    void set_neighborhood(int *numNeighbors,int **a,int** neighborsWeights);
    void set_neighborhood2(int *numNeighbors,int **a,int** neighborsWeights);
